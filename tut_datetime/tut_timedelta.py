...
# Basic operations
t1 = datetime.datetime(year=2020, month=5, day=17, hour=16, minute=0, second=00, microsecond=0)
t2 = datetime.datetime(year=2021, month=5, day=17, hour=16, minute=30, second=1, microsecond=500000)
delta = t2 - t1
