...
with open("../assymetric/device.key", "wb") as f:
    f.write(pem)
...
# Subject
DN = list()
DN.append(x509.NameAttribute(NameOID.COMMON_NAME, u'local.final'))
...
# Save IA certificate
with open(name='device.crt', mode='wb') as f:
