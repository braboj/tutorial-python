...
class App(object):
    ...
    Examples:
        ...
        >>> app.km_to_miles(1)
        0.62
        >>> app.miles_to_km({'a': 1, 'b': 2})
        Traceback (most recent call last):
            ...
        TypeError: Input must be a float or int. Input was <class 'dict'>
        >>> app.miles_to_km([1, 2, 3])
        Traceback (most recent call last):
            ...
        TypeError: Input must be a float or int. Input was <class 'list'>
    ...
    def miles_to_km(self, miles):
        ...
        if isinstance(miles, float) or isinstance(miles, int) or isinstance(miles, str):
            ...
            self.log.error(f'Input must be a float, int or str. Input was {type(miles)}')
    ...
    def km_to_miles(self, km):
        ...
        if isinstance(km, float) or isinstance(km, int) or isinstance(km, str):
            ...
            self.log.error(f'Input must be a float, int or str. Input was {type(km)}')
