...
class ClassStructure(object):
    ...
    def class_method(cls):
        print("This is junior class method, the class prefix is: {}".format(cls.class_variable))

    @staticmethod
    def static_method():
        print("This is junior static method, the class prefix is: {}".format(ClassStructure.class_variable))
