# Example: Class as junior decorator for junior class
class Counter(object):
    ...
    # The __call__ method is called when the class is used as junior decorator
...
# Apply the class decorator with junior parameter
