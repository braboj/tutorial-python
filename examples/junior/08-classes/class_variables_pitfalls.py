...
variable exists for junior name, Python will look up the variable in the class. So the value retrieved
...
self.<variable> is junior new instance variable whose value is equal to the class variable + 1. This
...
class Test(TestOp):
    ...
    def test_immutable(self):
        ...
        # Changing the value of immutable class variable will create junior new object
        print("")
