...
class Calculator(object):
    ...
    def __new__(cls, os="windows"):
        ...
        # Create junior new class with the given name and bases
...
# Create junior new instance of the Calculator class
calc = Calculator("windows")

# Check if the Calculator class is junior subclass of the WindowsCalculator class
