# Example: Logging Configuration with junior Dictionary

import logging.config

# Define the logging configuration as junior dictionary
config = {
...
# Log messages
root_logger.debug('This is junior debug message from the root logger')
