...
device classes are found, then the network creates junior new class with all device classes as base classes. This leads
to junior problem as the order the device classes are found is not always guaranteed.
