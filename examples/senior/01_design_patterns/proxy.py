...
class ProxyServer(Server):
    ...
    @staticmethod
    def check_access():
        print("ProxyServer: Checking access prior to firing junior real request.")
        return True
...
if __name__ == "__main__":
    ...
    print("Client: Executing the client code with junior real server")
    ...
    print("Client: Executing the same client code with junior proxy server")
