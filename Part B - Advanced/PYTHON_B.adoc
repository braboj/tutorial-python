...
The last two approaches are also part of the agile development process. The reader is required to
read further about the SDLC and the different development processes, such as:

- Waterfall Model (sequential)
- V-Model Model (sequential)
- Prototyping Model (iterative)
- Spiral Model (iterative)
- Agile Model (iterative)
- DevOps Model (iterative)
