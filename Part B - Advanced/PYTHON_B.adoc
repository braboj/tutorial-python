...
Here is a typical set of architectural artifacts:
...
- Integrated development environment (e.g. PyCharm, Github Codespaces)
...
- *Sequential development* is a development process where the steps of the development process are
performed sequentially.

- *Iterative development* is a development process where the same steps of the development process
are performed periodically. The iterative approach will be to build and release the system in
multiple iterations (releases). Each iteration will add more features to the system. It is very
suitable for monotlithic applications.

- *Incremental development* is an extension of the iterative development approach where the
system can be sliced into fully working systems that can undergo the iterative development process.
Each of these systems is called an *increment* and can be released independently. It is very
suitable for microservices applications.

The reader is required to read further about the SDLC and the different development processes, such
as:

- Waterfall
- V-Model
- Spiral
- Agile (Scrum, Kanban, Lean, Extreme)
- Prototyping (Rapid Application Development, etc.)
- DevOps (Continuous Integration, Continuous Testing, Continuous Deployment)
