...
- Focuses on the "what" an object is and does
...
__future__ library. The __future__ library provides features that will be standard in future
versions of Python. The __future__ library is used to avoid incompatibilities between Python 2
and Python 3.

The most commonly used features of the __future__ library are:
