...
software codebase. They are used to make software more flexible, maintainable, and reusable.
...
> The SOLID principles are a set of design principles that are used to minimize the change
in the software codebase.
...
image::part_b/ch_04/shapes_and_colors_with_inheritance.png[]
...
image::part_b/ch_04/shapes_and_colors_with_composition.png[]
